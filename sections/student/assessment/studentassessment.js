                        ...
                        <View className={`flex-1 h-full pt-12 px-4 pb-4`}>
                            {subjectAssignments ? (
                                <View className={`flex-1 h-full  p-4`}>
                                    {subjectAssignments.pending.length > 0 || subjectAssignments.submitted.length > 0 ? <View className={`flex-row mb-4 gap-[16px]`}>
                                        <TouchableOpacity
                                            className={clsx("flex-1 items-center py-2 rounded-lg", activeTab === "pending"
                                                ? `bg-blue-500`
                                                : `bg-[#6C6C6C]`,)}
                                        ...
                                        <TouchableOpacity
                                            className={clsx("flex-1 items-center py-2 rounded-lg", activeTab === "submitted"
                                                ? `bg-blue-500`
                                                : `bg-[#6C6C6C]`,)}
                                                    ...
                                                    {subjectAssignments.pending.map((item, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <TouchableOpacity
                                                                    onPress={() => {
                                                                        navigation.navigate("student/singleassessment", {
                                                                            id: item._id,
                                                                        });
                                                                    }}
                                                                ...
                                                                >
                                                                    <Text
                                                                        className={"text-white font-medium   pb-1 text-[12px]"}
                                                                        style={{
