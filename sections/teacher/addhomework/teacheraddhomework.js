            ...
            <>
                    ...
                    <View>
                        ...
                        <View className={` flex flex-col p-6 gap-[16px]`}>
                            ...
                            <View style={styles.descriptionContainer}>
                                <Text className=" pb-2" style={{ fontSize: 16, fontFamily: "Matter500" }}>Description</Text>
                                <TextInput
                            ...
                            >
                                <Text className=" w-full pb-2" style={{ fontSize: 16, fontFamily: "Matter500" }}>Class</Text>
                            ...
                            <View >
                                ...
                                <Text className=" w-full pb-2" style={{ fontSize: 16, fontFamily: "Matter500" }}>Attachment <Text className={`text-[#858585] `}>(optional)</Text>
                                ...
                                <TouchableOpacity
                                    className={clsx("text-[#858585] px-3 mt-3  border-[1px]  active:border-[1px] focus:border-[1px] focus:border-[#205FFF] w-full  justify-center items-center rounded-xl  pt-3.5 pb-[14.4px] bg-white flex flex-row ", selectedImageFile ? "border-[#205FFF]" : "border-[#EDEEF4]")}
                                    style={{
                                        height: 150
                                    }}
                                    onPress={() => {
                                ...
                                >
                                    {
                                        ...
                                        >
                                            <View className=" w-[200px] flex flex-col gap-2">
                                                <View className=" relative border-[#E4E4E4] flex flex-row items-center px-3  pb-2 gap-2 w-full border-[1px]  rounded-lg ">
                                                    ...
                                                    <View className=" leading-none flex flex-col gap-1">
                                                        <Text style={{ fontFamily: "Matter" }} className=" font-Matter text-[14.4px] text-[#3C3C3C]">
                                                            {file?.fileName.length > 15
                                                                ? `${file?.fileName.substring(0, 15)}...`
                                                                : file?.fileName}
                                                        </Text>
                                                        <Text style={{ fontFamily: "Matter500" }} className=" font-Matter font-medium text-[14.4px] text-[#999999]">
                                                            {(file?.fileSize / (1024 * 1024)).toFixed(2)}{" "}
                                                            MB
                                                        </Text>
                                                    </View>
                                                    <TouchableOpacity onPress={() => { setSelectedImageFile(null), Setfile(null) }} className=" absolute -top-3.5  -right-1.5">
                                        ...
                                        </View> : <View className=" font-Matter text-[#4B5563]  font-medium">
                                            ...
                                            <Text style={{ fontFamily: "Matter" }} className=" text-center text-[#9CA3AF] font-normal pt-2 text-[14.4px]">
                ...
                <View className="px-4 pb-4">
                    ...
                    <View className={`flex  flex-row justify-between  border-[1px] border-[#E4E4E5] rounded-full px-2  py-2 items-center`}>
                        ...
                        >
                            <Text style={{ fontFamily: "Matter500" }} className=" text-[16px] px-2">Add Homework</Text>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={addhomework}>
                            <Text
                                className="rounded-full text-white font-bold w-[100px] text-center bg-blue-500  px-3 py-4"
