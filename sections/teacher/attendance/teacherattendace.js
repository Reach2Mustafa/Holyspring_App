...
import Getattendancedates from "../../../api/getattendancedates";
                                                    ...
                                                    <TouchableOpacity
                                                        onPress={() => {
                                                            if (entry.holiday == false) {
                                                                navigation.navigate("teacher/takeattendence", {
                                                                    date: entry.date,
                                                                });
                                                            }
                                                            else {
                                                                ToastAndroid.show(` ${entryIndex + 1} ${month} is a holiday`, ToastAndroid.SHORT);
                                                    ...
                                                    >
                                                        <Text
                                                            ...
                                                            style={{
                                                                ...
                                                                borderColor: entry.holiday ? "#0470BC" : "#EAEAEE",

                                                                backgroundColor: entry.holiday ? "#0470BC" : "#fff",
                                                            }}
                                                        >
                                                            {entryIndex + 1}
                                                        </Text>
