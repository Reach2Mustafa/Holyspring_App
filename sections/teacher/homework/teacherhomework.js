                    ...
                    <View className={`flex-1 `}>
                        ...
                        >
                            {user?.teachingclass?.map((teachingClass, index) => (
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate("teacher/homeworkbyclass", { class1: teachingClass }), setActiveTab(teachingClass) }}
                                    key={index}
                            ...
                            <TouchableOpacity
                                onPress={() => { navigation.navigate("teacher/assignedhomework", { class1: "Assigned" }), setActiveTab("Assigned") }}
