        ...
        <View className=" flex-1">
                    ...
                    <View className={` p-6`}>
                        ...
                        {students?.map((student) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.studentItem,
                                    attendance[student._id].ispresent === "present" && styles.present,
                                    attendance[student._id].ispresent === "absent" && styles.absent,
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Text className="text-[13.76px]" style={{ fontFamily: "Matter" }}>{student.rollno}</Text>
                                </View>
            ...
            <View className="px-4 py-4">
                ...
                <View className={`flex  flex-row justify-between  border-[1px] border-[#E4E4E5] rounded-full px-2 py-2 items-center`}>
                    ...
                    >
                        <Text style={{ fontFamily: "Matter500" }} className=" text-[16px] px-2">Mark Attendance</Text>
                    </TouchableOpacity>
