...
import getteacherremarkadmin from "../../../api/getteacherremarkadmin";
...
const Teacherremarkall = ({ }) => {
    ...
    useEffect(() => {
        ...
        const getdata = async () => {
            ...
            setpageload(true);
            const data = await getteacherremarkadmin(id);
            setremark(data);
            setpageload(false);
                                ...
                                {remark
                                    ...
                                    .map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <Card field="Teacher:" details={item?.teacher?.name} />
                                            <Card field="Student:" details={item?.Student?.name} />
                                            <Card field="Student ID:" details={item?.Student?.rollno} />
                                            <Card field="Student Class:" details={item?.Student?.class} />
                                            <Card
                                                field="Remark date:"
...
export default Teacherremarkall;
